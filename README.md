...
**_Example3_**: to execute role1 and role2 on the stdalvm01, run the script as follows:

    $> sh Bash/<script-name> --envname <system-name> --tags 'role1,role2' --limit 'stdalvm01'
